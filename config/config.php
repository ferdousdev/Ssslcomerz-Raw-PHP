...
if (!defined('PROJECT_PATH')) {
    define('PROJECT_PATH', 'https://fairelectronics.com.bd'); // Replace this value with your project path
}
...
if (!defined('STORE_ID')) {
    define('STORE_ID', 'fairelectronicscombdlive');
}

if (!defined('STORE_PASSWORD')) {
    define('STORE_PASSWORD', '61B82F9A2C91F49106');
}
