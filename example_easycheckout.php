        ...
        <div class="col-md-8 order-md-1">
            ...
            <form method="POST" class="needs-validation" novalidate>
                ...
                <div class="custom-control custom-checkbox">
                    ...
                    <input type="hidden" value="1" name="emi_option" id="emi_option" required/>
                    <input type="hidden" value="12" name="emi_max_inst_option" id="emi_max_inst_option" required/>
                    <input type="hidden" value="6" name="emi_selected_inst" id="emi_selected_inst" required/>
...
<script>
    ...
    obj.emi_option = $('#emi_option').val();
    obj.emi_max_inst_option = $('#emi_max_inst_option').val();
    obj.emi_selected_inst = $('#emi_selected_inst').val();
