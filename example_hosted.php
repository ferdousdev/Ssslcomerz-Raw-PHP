...
<head>
    ...
    <title>Samsung eStore Post Payment | SSLCommerz</title>
...
<div class="container">
    <div class="py-5 text-center">
        <h2>Samsung eStore Post Payment</h2>
...
<input name="store_id" type="hidden" value="estore001live" /> 
<input name="success_url" type="hidden" value="https://estore.fdl.com.bd/index.php/shop/success-payment" /> 
<input name="fail_url" type="hidden" value="https://estore.fdl.com.bd/index.php/shop/fail-payment" />
 <input name="cancel_url" type="hidden" value="https://estore.fdl.com.bd/index.php/shop/cancel-payment" />
  <input name="version" type="hidden" value="2.00" />
    ...
    <footer class="my-5 pt-5 text-muted text-center text-small">
        <p class="mb-1">&copy; 2020 FDL Estore</p>
